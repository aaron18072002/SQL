...
-- java22-shopping dbp 02.sql --> liên quan đến SUPPLIER
-- T100_SUPPLIER, T101_SUPPLIER_CHAIN

-- java22-shopping dbp 03.sql --> liên quan đến CUSTOMER, EMPLOYEE
-- T08_CUSTOMER, T11_TITLE, T131 EMPLOYEE

-- java22-shopping dbp 04.sql --> liên quan đến enum, constant
-- T09_PAYMENT_METHOD, T10_ORDER_STATUS

-- java22-shopping dbp 05.sql --> liên quan đến order
