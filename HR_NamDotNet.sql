...
--CASCADE nghĩa là nếu một hàng trong bảng cha bị xóa, 
--tất cả các hàng liên quan trong bảng con cũng sẽ bị xóa tự động
--bảng cha là bảng chứa Primary Key - bảng con là bảng chứa Foreign Key
...
SET IDENTITY_INSERT dependents ON; --được sử dụng để tạm thời cho phép chèn các giá trị tùy ý vào cột IDENTITY
